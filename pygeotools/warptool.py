...
def main():
    ...
    parser.add_argument('-tr', default='first', help='Output resolution (default: %(default)s)', choices=tr_choices)
    parser.add_argument('-te', default='intersection', help='Output extent (default: %(default)s)', choices=te_choices)
    parser.add_argument('-t_srs', default='first', help='Output projection (default: %(default)s)', choices=t_srs_choices)
